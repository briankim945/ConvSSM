...
from src.models.convS5FFT.conv_ops import VmapBasicConv
from src.models.convS5FFT.diagonal_ssm import init_ConvS5SSM_FFT
from src.models.base import ResNetEncoder, ResNetDecoder
from src.models.convS5FFT.layers import StackedLayers
...
class CONVS5_FFT_NOVQ(nn.Module):
    config: Any
    training: bool
    parallel: bool
    ...
    def setup(self):
        ...
        # Sequence Model
        self.ssm = init_ConvS5SSM_FFT(config.ssm['ssm_size'],
                                  config.ssm['blocks'],
                                  config.ssm['clip_eigs'],
                                  config.d_model,
                                  config.ssm['A_kernel_size'],
